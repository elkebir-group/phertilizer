...
from utils import  dict_to_dataframe, mapping_to_dataframe, pickle_load,  pickle_save, timing
...
class Phertilizer:
    ...
    def till(self,  max_copies, alpha, seed  =10262022):
        ...
        self.copy_distance = squareform(pdist(self.bin_count_data, metric="euclidean"))
    ...
    def phertilize(self, alpha, 
        ...
        optimal_tree, loglikelihoods = pre_proc_trees.find_best_tree(self.like0, self.like1)
